module.exports = [
  ...
  },
  {
    ...
    story:
      '背景故事人们所说的翠神，真正的名字是艾翁·荆足。半人半树的它，常在符文之地的丛林中游荡，所经之处无不生机盎然。他知晓自然界的种种秘密，无论是飞禽走兽还是游鱼虫孑，都与他交谊深厚。在逍遥四野的途中，艾翁会向路遇的人传授奇特的智慧，或是培植丰茂的丛林。时不时地，他也会向口风不严的蝴蝶托付自己所知的秘密。'
  },
  {
    id: 'tahmkench',
    title: '河流之王',
    ...
    story:
      "''世界，就是一条河流，而我，是它的国王。''塔姆丶肯奇在符文大陆的各个水道游历着，用毫无戒心者们的悲惨喂养着他那贪得无厌的食欲。这个充满奇异魅力的美食家纵情享受着猎物们受苦时的每个时刻。一次伴随着两件外套*的交易也许会带你通往任何想去的地方，但你的旅程几乎必然会在绝望的深渊中结束。（注：“两件外套”是一首福音曲，歌词大意是关于一新一旧两件外套的选择，其中的新外套是由救世主赐予的，然而塔姆并不像救世主那样仁慈。）"
  },
  {
    id: 'xayah',
    title: '逆羽',
  ...
  },
  {
    ...
    story:
      '在他的实验室内，一种可怕的饥渴占据了沃里克。当他的徒弟辛吉德惊恐地望着他时，沃里克甩开据点大门，狂奔向未知的地方，一路上发出令人毛骨悚然的嚎叫。'
  },
  {
    id: 'jinx',
    title: '暴走萝莉',
    ...
    story:
      "''我有——最美好的初衷''金克丝活着就是为了不计后果的四处肆虐，在她身后留下的只有一片混乱与恐慌。她是一名暴躁而残忍的罪犯，她蔑视一切仅仅是因为无聊，她会在她认为最无趣的地方：皮尔特沃夫，欢乐地进行带着她烙印的肆虐，以引起混乱。她携带着兵工厂里的致命玩具，她引发着最闪耀而响亮的爆炸——这也是为了引起倒霉的当局的震惊与注意。金克丝总是能够逍遥法外，她最爱的游戏就是戏弄皮城的警察——尤其是蔚。"
  },
  {
    id: 'leblanc',
    title: '诡术妖姬',
    ...
    story:
      '"接下来，我要让你的生命条消失！" —乐芙兰曾经是贵族时代的幕后黑手，黑色玫瑰领导人的乐芙兰，经历过辉煌也经历过挫折。但这位邪恶的女妖术师不屈不挠地打拼出自己的一席之地，究竟是什么样的力量在支撑她？。'
  },
  {
    id: 'leona',
    title: '曙光女神',
    ...
    story:
      "''太阳的光芒笼罩着整个符文之地，而此刻我的盔甲也褶褶生辉。''在高耸入云的巨神峰上，有一个叫做拉阔尔的民族自古就在此生息繁衍，他们是一群拥有战士天赋的民族。族群中能力超群的人可以登上嘉岗坦山的顶峰，响应“神圣”召唤。这群人又叫做烈阳族，他们退出战争，将生命献给了崇敬的太阳。"
  },
  {
    id: 'lulu',
    title: '仙灵女巫',
    ...
    story:
      "''这种天马行空的幻想能力，难道是水瓶座女生？''璐璐率性而为的程度，也许联盟中没有哪个英雄能够比得上。在班德尔城中度过的青春岁月中，她总是把大部分时间都花在林间漫步或者做白日梦上。这并不表示她不合群；班德尔城日复一日的喧嚣，根本比不上她想象中的那个多姿多彩的世界。"
  },
  {
    id: 'thresh',
    title: '魂锁典狱长',
    ...
    story:
      "''人心是肉长的……玩具。''锤石是一个残酷成性的幽灵收割者，以折磨生灵和死灵为乐。他曾是一个蹂躏囚犯的无情狱卒，后来被受他折磨的囚犯们吊死在他自己的锁链上。在他的恶毒本质解开束缚后，魂索典狱长游荡在符文大陆，寻找着猎物。他取乐的方式，是先把那些最为不羁的猎物们的意志给破坏掉，然后将他们的灵魂捕获到他的那盏泛着幽绿光芒的灯笼中。"
  },
  {
    id: 'aatrox',
    title: '暗裔剑魔',
    ...
    story:
      "''根本没人理解我，他们以为我在切菜''亚托克斯是一位传奇战士，也是一个被称为暗裔的上古种族里仅存的五位战士之一。他优雅镇定地挥舞着巨剑，用令人迷离的剑式在千军万马中穿行。每当敌人倒下，亚托克斯那把如同活物般的巨剑便会啜饮着他们的鲜血，同时增强他的力量，并为他残暴、优雅的杀戮战役提供给养。"
  },
  {
    id: 'ahri',
    title: '九尾妖狐',
    ...
    story:
      "''慈悲是人类的奢侈之举，但也是责任所在。''跟其他游荡在艾欧尼亚南部丛林中的狐狸不同，阿狸总觉得她跟魔法世界有一种说不清道不明的联系，一种不完整的联系。在内心深处，她觉得她难以适应这具生而拥有的肉体，梦想有一天可以变成人类。这个梦想看起来遥不可及，直到有一天人类战场上发生的事情改变了她。"
  },
  {
    id: 'riven',
    title: '放逐之刃',
    ...
    story:
      "''战争与谋杀之间，潜藏着我们的心魇。''在诺克萨斯，每一位居民都可以平步青云，而无论其种族、男女、贵贱——实力，就是一切。锐雯曾怀着对此理想的坚定信仰，不懈地追求着远大的前程。她曾是一位初露锋芒的士兵，那时的她能够挥动一把与自己差不多重的长剑。她曾是一位无情高效的勇士，但是她真正的实力潜藏在她的信念之中。"
  },
  {
    id: 'orianna',
    title: '发条魔灵',
    ...
    story:
      '奥莉安娜和她的科技球现在是联盟英雄的一员。她认真尝试适应周围的人。但无论多么努力，奥莉安娜永远不可能成为真正的人类，只有极少数人能忽略她非人的本质。在更多人眼里，奥莉安娜只是一副没有灵魂的发条外壳。'
  },
  {
    id: 'camille',
    title: '青钢影',
    ...
    story:
      '精准与否，就是屠宰与手术的区别卡蜜尔是一名精英特工，为了皮尔特沃夫的权势阶层维护着城市的秩序。在责任心的驱使下，青钢影将自己的身体改造成了一台海克斯动力驱动的杀戮机器。当卡蜜尔追捕目标时，她就会变得冷静、无情，并且极其可怕地精确。'
  },
  {
    id: 'irelia',
    title: '刀锋舞者',
    ...
    story:
      '那把剑狂乱飞舞，仿佛以血涂饰。-选自诺克萨斯艾瑞莉娅回身冲入敌军，操控手中巨剑。巨剑轻灵起舞，在诺克萨斯人的惊恐中斩杀敌人。受到重创的入侵者被迫从爱欧尼亚撤退。艾瑞莉娅加入了联盟。'
  },
  {
    id: 'lucian',
    title: '圣枪游侠',
    ...
    story:
      "''她曾是我的全部，但他们带走了她 和她一起被带走的还有我的友善与仁慈。''卢锡安将灌输着远古力量的遗物作为武器，以坚定守护神的身份对抗着亡灵生物。他冷酷的信念从未动摇，即使面对着令人发狂的恐惧，他也会咆哮着用圣焰将之毁灭。卢锡安独自承受着一项残酷的任务：净化那些被亡灵生物诱捕的灵魂，他的永远挚爱也在此之中。正如他们装配的双生遗物武器一般，卢锡安和他的妻子赛娜如同用相同的石头雕刻而成。他们共同在符文大陆战斗多年，将圣光带向黑暗，净化那些被腐败夺走的人们。他们是正义的风向标：赛娜对事业的奉献从未迟疑，卢锡安的友善与热心则感动了许多被他们拯救的生命。..."
  },
  {
    id: 'zoe',
    title: '暮光星灵',
    ...
    story:
      '佐伊是调皮、想像力跟改变的化身。作为代表巨神峰与星空联系的信使，佐伊能够预示即将改变世界的重大事件。她的存在本身扭曲了掌管现实的神秘法则，有时一个无心的差错就会引起足以动摇世界的灾变──尽管她没有丝毫恶意。这也许能够解释为何佐伊总是以一种轻松，甚至可以说是有些不认真的态度履行她的义务。她把大部分的时间都拿来玩耍、恶作剧，或是想一些其它的花招来娱乐自己。佐伊可爱无害的外表也许让你觉得与她相遇是一件开心的事，但事实往往比你以为的还要复杂，还要危险。'
  },
  {
    id: 'yasuo',
    title: '疾风剑豪',
    ...
    story:
      "''死亡如风，常伴吾身''亚索是一个百折不屈的男人，还是一名身手敏捷的剑客，能够运用风的力量来斩杀敌人。这位曾经春风得意的战士因为诬告而身败名裂，并且被迫卷入了一场令人绝望的生存之战。即使整个世界都已与他为敌，他也要竭尽所能地去将罪恶绳之以法，并恢复自身的名誉。"
  },
  {
    id: 'syndra',
    title: '暗黑元首',
    ...
    story:
      "''我的能量，无穷无尽！''辛德拉生来就具有无边的魔法潜能，除了爱好以自己的意志来运用这难以置信的能量外，就再无所好。随着每一天的过去，她的魔力天赋也变得更加有效且更具毁灭性。辛德拉拒绝任何平衡或克制的观念，只想保持她的能量的控制权，即使它意味着那些想要制止她的当局会废掉她。在艾欧尼亚度过的年少时光里，辛德拉对魔法的鲁莽使用吓坏了村庄的长老们。他们将她带到一个偏僻的寺庙，把她交给一个老法师照顾。令辛德拉愉快的是，老法师解释说，这个寺庙是一间学校——老法师可以在这里指引她，让她发展她的才能。..."
  },
  {
    id: 'varus',
    title: '惩戒之箭',
    ...
    story:
      "''一支箭矢的生命一闪即息，支撑它的唯有方向与目的''由于他举世无双的弓术和无可置疑的荣誉感，韦鲁斯被一间神圣的艾欧尼亚寺院选作守望者。这个寺院是为了镇压一个远古的腐败深渊而建。这个深渊是那么地令人不安，以至于艾欧尼亚的长老们害怕它将整个岛屿都笼罩在黑暗之中。"
  },
  {
    id: 'caitlyn',
    title: '皮城女警',
    ...
    story:
      '最初，皮特沃夫为了发展高科技，进口了很多珍贵资源，强盗和小偷们发现这块肥肉后便经常光顾这里。传说中的皮城女警凯特琳琳就此诞生！'
  },
  {
    id: 'nidalee',
    title: '狂野女猎手',
    ...
    story:
      '宏伟屏障的南部是一片被诅咒的凶险之地，因此人烟稀少，而英雄更是凤毛麟角。那里的大部分地区仍然残留着上次符文战争留下的创伤，特别是神秘的库莽古森林。在这些陌生的土地上蕴藏着被人久已遗忘的宝藏，许多人不惜冒生命危险去寻宝。奈德丽当时只是一个小姑娘，随着寻宝的父母一起迷失在这片茂密的雨林中。丛林是无情的，她眼睁睁地看着自己的父母染上莫名的恶疾在痛苦与煎熬中死去。就是在这样恶劣的环境中，奈德丽奇迹般地生存了下来。由于她天真无邪，童稚可人，丛林中的野兽都很喜欢她。更幸运的是，居住其中的美洲狮一家将她当作自己的亲人般抚养。奈德丽渐渐长大了，并不知不觉地吸收着茂密丛林的魔法原力，她的进化超越了人类和猫科的本能。奈德丽现在已经成长为神话般存在的凶狠捕猎者，用她的尖牙利齿抵御着胆敢侵犯她丛林的家园的敌人。'
  },
  {
    id: 'zac',
    title: '生化魔人',
    ...
    story:
      "''妈妈说我看上去比实际年龄大''扎克是祖安某个实验的产物。这个实验是为了制造海克斯生化超级士兵——祖安无定型战斗体。他结合了残暴的力量和无限的灵巧，是一名全能的主宰者：这个创造性的战士可以弹过障碍并猛击他的敌人直至屈服。尽管扎克出生于武器实验室，却被一对有爱的父母救下并收养，并且成了一个和蔼友善的小孩。随着岁月的流逝，他逐渐成长为一名勇猛的英雄，宣誓保护祖安的普通老百姓们。"
  },
  {
    id: 'khazix',
    title: '虚空掠夺者',
    ...
    story:
      "''他们绝对想不到会是这样！''一头来自虚空、名为卡兹克的恶毒掠食者渗入了瓦洛兰，准备吞噬这块大陆上最有潜力的生物们。每次猎杀后，他都会吸收掉猎物的力量，让自己进化得更加强大。卡兹克最渴望征服和吞噬的对象是雷恩加尔，一只与他实力在伯仲之间的野兽。当卡兹克刚刚穿越到这个世界时，他非常地脆弱和饥饿。他最先遇到的一批动物实在是太弱小了，难以为他的快速进化提供给养。于是，卡兹克将他的目光转移到他所能找到的最为危险的生物上，即便冒着生命危险，也要满足进化所需的给养。每次击杀都让他大快朵颐，焕然一新，变成更强更快的掠食者。..."
  },
  {
    id: 'sion',
    title: '亡灵战神',
    ...
    story:
      '诺克萨斯是一个为达目的可以连传统道德都抛弃的城邦。对于诺克萨斯来说，除了使用暴力的意愿，其他都无关紧要。而这点则在杀戮战士赛恩的身上得到了最好的体现。赛恩会用他那巨大的双刃斧头"切削者"无情地杀戮敌人。'
  },
  {
    id: 'Pyke',
    title: '血港鬼影',
  ...
  },
  {
    ...
    story:
      "''说教无益。折断的骨头是更好的课本。''俄洛伊的体格强横无比，却唯独会在她的坚定信仰面前屈身。作为大海兽的先知，她挥舞着一个巨大的金色神像，将敌人的灵魂抽离体外，将他们对现实的感知完全击毁。所有对“娜伽卡波洛丝的真者”发起挑战的人，很快就会发现，俄洛伊从来不单打独斗——蟒行群岛的众神会与她并肩作战。"
  },
  {
    id: 'tryndamere',
    title: '蛮族之王',
    ...
    story:
      '“我的右手比左手要强！”泰达米尔从他的父亲手中继承了大剑，而这把剑也是他父亲从泰达米尔祖父那里继承来的。多年来他一直铭记着父亲的教诲“熟练掌握它，就能拥有它。”他和寒冰射手艾希缔结了政治婚姻，并一起为守护联盟的子民们而战。'
  },
  {
    id: 'reksai',
    title: '虚空遁地兽',
    ...
    story:
      "''嘚~~~''雷克塞是她族群之中体型最大、脾气最暴的。她是一个无情的掠食者，可以在地底挖掘隧道，来伏击并吞噬她的猎物。她那永不满足的饥渴已经使鼎盛一时的恕瑞玛帝国遍布废墟。商人、贸易者和武装商队都会绕行百里，来躲开这些广袤的地区，但是狡诈的盗匪们会引诱粗心的人们进入雷克塞的杀戮之地。一旦雷克塞侦测到你，你的命运就已注定。毫无逃生的希望；她是来自沙砾之下的死亡。"
  },
  {
    id: 'volibear',
    title: '雷霆咆哮',
    ...
    story:
      "''没有战争，熊人族不会领悟和平。''弗雷卓德的无情北壁是熊人族的家园，这个凶猛好战的种族在这块冻土之上已经经历了上千年的洗礼。他们的首领是一位暴怒的敌手，他可以召唤闪电的力量击打敌人，以使其畏惧：他就是沃利贝尔，他既是个战士也是个谜团，致力于守护上古传统和部族里的战士精神。"
  },
  {
    id: 'anivia',
    title: '冰晶凤凰',
    ...
    story:
      '艾尼维亚是拥有强大能量的不朽存在。她可以瞬间冰封身前的地面，用寒冰冻结一切，甚至操纵寒冰使其剧烈爆炸，向各个方向发射锋利的冰片。她还能召唤一阵冰川风暴，用狂暴的暴风雪对范围内的单位造成伤害并减速。需要防御时，艾尼维亚可以生成一道无法穿越的冰墙。'
  },
  {
    id: 'nami',
    title: '唤潮鲛姬',
    ...
    story:
      "''我的命运由我做主。''娜美引导着海洋的原始能量，来统御海洋神秘的恢复特性，并号令潮汐本身的狂野能量。尽管被大部分人质疑，娜美仍然具有承担起一个没有人愿意承担的危险使命的勇气和决心。现在，她的人民坚信她是唤潮者，一个命中注定要去完成一项事关她整个族群生存的使命的天选之人。唤潮者的神圣使命是去获取一个月石，一个仅在地表世界的高耸山巅上找到的物体。她的人民，鲛人族，依赖月石的光芒来避开深渊里的恐惧之物。不过，月石的能量只会持续一百年。..."
  },
  {
    id: 'talon',
    title: '刀锋之影',
    ...
    story:
      "''来挑战我们吧，如果你够胆的话。''泰隆最早记住的东西，就是诺克萨斯地下隧道的阴暗，以及手中刀刃那令人放心的可靠感。他对家庭，温暖，或是友善没有一点印象。所窃金币的叮当作响，以及身后墙壁的安全感，反而是他曾渴望的一切。"
  },
  {
    id: 'sol',
    title: '铸星龙王',
    ...
    story:
      "''　奥瑞利安•索尔曾创造了奇迹般的群星，为无垠的荒芜太空布下他宏伟的恩典。为了重返铸星大道，奥瑞利安•索尔誓要夺回属于自己的自由。哪怕召星降怒，倾覆众生。''奥瑞利安•索尔，这一古老的存在，远在星云的残迹汇聚成万千世界之初便早已现身。自从降生于太息之初，他便在无垠的空无中遨游，寻觅着散落于广袤深空中可称奇伟的光华，渲染他亘古凭飞的漫卷长天。正如星空之龙来自天外，奥瑞利安•索尔从未遇见过任何能与之比肩的存在。"
  },
  {
    id: 'Kaisa',
    title: '虚空之女',
  ...
  },
  {
    ...
    story:
      '远古时代，整个世界都充斥着暴乱和冲突，凯尔是战争中的英雄，正义的使者，被人们称作天使的人。然而，也有一部分人称她做杀手或者怪物。凯尔为了自己的人民不屈不挠的战斗着，让他们的敌人全部在自己跪倒在自己面前。'
  },
  {
    id: 'gnar',
    title: '迷失之牙',
    ...
    story:
      "''丛林不会原谅盲目与无知。每根断枝都在讲述着故事。''我已经猎遍了这个丛林里的所有生物。我确信，这儿以前已经没剩下什么挑战了，但现在，这儿有了新来客。它的脚印和长牙领主一般大小；它的爪子就像弯刀。它能把人撕成两半。总算碰到有价值的猎物了。在我穿越丛林追踪我的猎物时，我开始看到这家伙所造成的破坏。我踏进了一个由破裂的树木们形成的怪异圆环。这些巨大的木质哨卫们已经在这片土地上矗立了无数岁月，它们铁一般的树皮，曾让那些手拿破斧又想砍伐它们的蠢货们无可奈何。..."
  },
  {
    id: 'shyvana',
    title: '龙血武姬',
    ...
    story:
      "''以吾父之血，取尔等之命！''在符文之地，有少数龙类，能熟练地运用他们的独特骨骼里所流淌的强烈魔法能量，因而进化成了一种罕见的天空之龙。这些强大且神秘的生物，绝大部分时候都隐藏在远离人类国家的地方。不过，有一些会被人类文明所吸引，并变成人类的形态，将自己融入到人类世界中去。"
  },
  {
    id: 'zed',
    title: '影流之主',
    ...
    story:
      "''无形之刃，最为致命。''劫是200年以来第一个冲破古老、禁忌之路的忍者。他违抗了他的宗族和导师，抛弃了束缚他一生的均衡与信条。劫现在为那些拥抱影之奥义的人提供力量，并屠杀那些墨守成规的人。劫是一个孤儿，他被一名伟大的忍者大师收养并训练。在他心目中，只有一个人能与他匹敌，他就是大师的儿子，慎。劫似乎永远都得不到导师的青睐，因为他与对手们的每一次较量都是以平局结束。在挫败感和嫉妒心的驱使之下，他开始寻找取胜之道。这个年轻的忍者冒险进入了宗族寺庙里的禁地，并找到了一个装饰华美的不祥之盒。..."
  },
  {
    id: 'diana',
    title: '皎月女神',
    ...
    story:
      "''一轮新月正在冉冉升起~''黛安娜——月之力的一个不屈化身——开展了一次针对崇拜太阳的烈阳族的黑暗远征。尽管她曾经试图寻求她的民族的认同，可是多年的徒劳无功将她消磨成了一个郁郁寡欢、满腔怨气的战士。现在，她给她的仇敌们下达了一个可怕的最后通牒：要么敬畏月之光华，要么死在她的新月之刃下。尽管出生于烈阳族，但黛安娜寻根问底的天性让她与同胞们格格不入。她总会在夜空中找到指引与抚慰，并且质疑太阳在她的社会中的统治地位。烈阳族的长老们只会用嘲笑和惩罚来回应她的诸多盘问。..."
  },
  {
    id: 'hecarim',
    title: '战争之影',
    ...
    story:
      "''无情利刃所向，尽皆披靡。恐惧铁蹄之下，生灵涂炭。''赫卡里姆是一只披坚执锐的庞然大物，从暗影岛狂奔而出，带领着一群幽灵骑兵猎杀鲜活的生命。赫卡里姆是人与野兽的融合体，诅咒让他永世狂奔，杀戮让他欣喜若狂，铁蹄让他碾压一切生灵。"
  },
  {
    id: 'velkoz',
    title: '虚空之眼',
    ...
    story:
      "''在虚空存活下来的人类？难以置信！''我进入了突如其来的强光。闪烁。闪烁，闪烁，闪烁。我调整好眼睛，评估我前方的景观。有东西在乱窜。我往下看，发现了一只小个的白色生物，用后腿站立着，嗅闻着我的躯体。它吸引了我的注意。你有什么用途？"
  },
  {
    id: 'skarner',
    title: '水晶先锋',
    ...
    story:
      "''我的毒刺，不会让你失望''斯卡纳，水晶守卫，保卫着一个深埋于恕瑞玛荒漠下的国度的入口。少数擅自闯入他的地盘并活下来的人形容他是一个拥有令人恐惧的智力、愤怒和准度的生物。这个残忍的生物在守护着什么，没人知道。"
  },
  {
    id: 'xerath',
    title: '远古巫灵',
    ...
    story:
      "''魔法，他在召唤我''强得无可估量，被称作泽拉斯的飞升生命体曾是一个有血有肉的凡人。他现在是一个截然不同的东西——一个由翻腾的奥术能量形成的生命体。从千年的囚禁中解脱后，他现在准备在符文之地上释放他的能量，并彻底毁灭任何反对他的人。"
  },
  {
    id: 'ezreal',
    title: '探险家',
  ...
  },
  {
    ...
    story:
      "''就像打野鸭子一样轻松''奎因和华洛是一对精锐的游侠搭档。凭借着弩弓和利爪，他们深入敌军领土执行着祖国最为险峻的任务，小至快速侦查，大至致命刺杀。这对搭档那牢不可破的羁绊在战场中非常致命，敌方在被摧残并身中百箭之后，才会意识到与他们进行战斗的不只一人，而是两位德玛西亚的传奇。"
  },
  {
    id: 'yorick',
    title: '牧魂人',
    ...
    story:
      "''在鬼影重重的暗影岛上无休止地挖掘墓穴然后填土''约里克是一个骇人的悲剧人物，也是存在于死亡边缘上的一个食尸鬼般的生物。有些人说，他曾是他的家族的最后一人，并且在死的时候没有任何子嗣来传承血脉，并且他还身中诅咒，即使死后也要延续他家族的使命。"
  },
  {
    id: 'wukong',
    title: '齐天大圣',
    ...
    story:
      "''哼，你们还没见识过俺老孙的真本事呢！''在战争学院里，有很多来自异世界的英雄，其中的大部分都是被召唤师们给“请”来的，而另一小部分，则不请自来。齐天大圣孙悟空，就是其中之一。成佛后的平淡生活，让生性贪玩的孙悟空感到枯燥不已。在一次神游异世的过程中，他发现了符文大陆这个能量波动异常频繁的世界。"
  },
  {
    id: 'azir',
    title: '沙漠皇帝',
    ...
    story:
      "''恕瑞玛，你的皇帝回来啦。''曾是一名被自大与傲慢所蒙蔽的凡人，对灼热沙漠有着无上统治权的阿兹尔以一个飞升者的身份重新归来。他想让恕瑞玛重回昔日的荣光，但在称霸途中遇上一些阻挠。然而，阿兹尔的力量是不容质疑的。"
  },
  {
    id: 'trundle',
    title: '巨魔之王',
    ...
    story:
      '一个睿智的Ruhgosk萨满发现他可以将整个部落的诅咒通过魔法转移到某一个巨魔战士身上，然而，部落里一直没有这样的战士出现...直至Trundle出生。他生来就有超凡的自愈能力，似乎部落里感染的疾病对他毫无影响一样。'
  },
  {
    id: 'nautilus',
    title: '深海泰坦',
    ...
    story:
      "''被无边的黑暗吞噬时，除了向前，别无他法。''从前，诺提勒斯曾是一名受战争学院委任，去探索守护者之海未知流域的海员。这次远征曾让他深入未知的水域。当时，他和其他海员找到了一大片正在泄露的黑色液体，并且没人知道是什么。尽管他们的工作就是调查他们所找到的新事物，但是船上除了诺提勒斯之外，没人敢于面对这片黑水。"
  },
  {
    id: 'darius',
    title: '诺克萨斯之手',
    ...
    story:
      "''团结一致的诺克萨斯能够掌控整个世界''提到诺克萨斯力量的象征，没有人能比德莱厄斯这名城邦中最让人畏惧和久经沙场的战士更加适合了。自幼失去双亲的德莱厄斯，为了让他自己和弟弟活下去，不得不进行战斗。到他加入军队的时候，他已经练就出了如同身经百战的老练士兵一般的力气和纪律性。"
  },
  {
    id: 'nunu',
    title: '雪原双子',
  ...
  },
  {
    ...
    story:
      '不要被迦娜的美貌迷惑，她是最可怕的毁灭风暴！迦娜在战斗中积累无数经验和技巧，她不仅能预判敌人的战术做出反应，还能增加友军的攻击和移动速度，代领他们走向胜利。'
  },
  {
    id: 'gragas',
    title: '酒桶',
  ...
  },
  {
    ...
    story:
      '艾欧尼亚岛上存在一个上古教派，致力于维护均衡。规则与混乱、光明与黑暗——万物必须和谐共存，这就是宇宙的真理。该教派名为均衡教派，维护世界均衡的神圣使命则由三个暗影战士来执行。阿卡丽便是这三名暗影勇士中一员，她肩负着修枝的神圣职责——将威胁瓦洛兰大陆和谐的敌人消灭干净。阿卡丽自小和母亲一起习武，练就一身好武功。母亲的训练严酷无情，她的基本原则是：“我们是在替天行道”。阿卡丽十四岁加入均衡教派，那时她就能空手砍断链条。毋庸置疑，她将继承母亲“暗影之拳”的名号。她的所作所为别人可能无法理解，但在阿卡丽看来，她在执行母亲神圣的信条。现在她和同伴慎，凯南一起维护着瓦洛兰大陆的平衡。这一神圣的追求毫无疑问地将三个暗影战士领向正义之地。'
  },
  {
    id: 'twitch',
    title: '瘟疫之源',
    ...
    story:
      '祖安是一座科技、魔法、重商主义混杂的扭曲之城。年轻的次世代技术科学大大地促进了文明的发展，而它在祖安的研究与应用也日益扩展了道德的边界。不计其数的工厂与实验室不断地向环境排泄废弃物，令祖安变成了一个乌烟瘴气之地。与祖安的天空相比，它的地下污染则更为严重。所有祖安的废弃物都汇聚在它的下水道里，混合成一种剧毒而神秘的调合物。从这种可怕混合物里诞生了一只瘟疫鼠——图奇。不同于他的尚未进化的表亲，图奇具有与人无异的知觉……如果他们与他一般疯狂的话。而这种进化的副产物则是图奇的狂躁疯癫，虽然是在官能方面。图奇来到了英雄联盟，在正义之地上展示自己是“他的种类中的独一无二”。自此以后，他在祖安——也就是赋予他进化的感知的城市，找到了一位慷慨的资助者。图奇是祖安在联盟的最早的英雄之一，当瓦洛兰城邦起了政治纷争之时，他便为祖安而战。他曾公开表示他在联盟工作的目的便是为了获得足够的影响力与物质财富，来努力重造他获得感知的过程。虽然他的追求面临着诸多的挑战——其中最大的挑战之一便是他自身的疯癫。如果他成功了，则意味着整个符文之地的进化向前迈出了巨大而无耻的一步。虽然祖安在此事中的隐秘用心还不得而知，但祖安向图奇保证支持他的追求。图奇的存在证明在符文之地一切皆有可能。”— 黑默丁格。'
  },
  {
    id: 'renekton',
    title: '荒漠屠夫',
    ...
    story:
      '雷克顿来自遥远一个的世界，和哥哥内瑟斯一样都是兽形种族的一份子，统治且保护着人类。雷克顿和内瑟斯一起管理秘藏着远古智慧和生死循环奥义的大图书馆。'
  },
  {
    id: 'viktor',
    title: '机械先驱',
    ...
    story:
      "''于人之手，科技魔法技术乃工具也。为人之手，则其乃解放也。''在年轻时，维克托就发现了他对科学与发明的激情，特别是机械自动化这一领域。他参加了祖安享有盛名的科技魔法大学，并带领了一支队伍，研发出了布里兹这一科学史上的突破，并期待着这项发明能够让他登上职业生涯的巅峰。不幸的是，他的傲人成果被斯坦里克教授给篡夺了。"
  },
  {
    id: 'elise',
    title: '蜘蛛女皇',
    ...
    story:
      "''听说男人都喜欢腿多的女人！''伊莉丝那令人着迷的美貌和优雅下隐藏着一个致命掠食者的残忍与黑暗的心。冷酷狡猾的她将蜘蛛之神的恩赐作为承诺，用来诱惑那些毫无戒心的人。伊莉丝已经将自己的人性换成了一些更加邪恶的东西，通过牺牲无辜的人来维持她的力量与看似永恒的青春。没人能数得清楚，已经有多少人被她抓到网中杀死并用来喂养她那永无止境的饥饿了。"
  },
  {
    id: 'poppy',
    title: '圣锤之毅',
    ...
    story:
      '“我不是英雄。只是个拿锤子的约德尔人。”符文之地不乏英勇之人，但很少有人能和波比一样坚毅。带着长度两倍于她身高的锤子，这个决绝的约德尔人已经花费了数不清的岁月来寻找那个“德玛西亚英雄”。然而，这位据称是她武器的合法持有人的英雄，只是个虚构出来的人物。'
  },
  {
    id: 'jayce',
    title: '未来守护者',
    ...
    story:
      "''皮尔特沃夫能强势地面对任何威胁''武装着睿智与魅力，以及标志性的可变形铁锤，杰斯毕生致力于守护他的祖国，皮尔特沃夫。靠着发明家的身份而闻达于世的他，用充满磁性的人格以及创意新颖的作品照亮了城邦人民的生活。/p>"
  },
  {
    id: 'taliyah',
    title: '岩雀',
    ...
    story:
      '何枝可依塔莉垭来自恕瑞玛，怀有操纵岩石的能力。身为一名流浪法师，她洋溢着饱满的热情，天真而又坚定。她在年幼的憧憬与成人的责任之间苦苦求索，踏遍了瓦洛兰的山山水水，只为寻得控制己身异能的法门。据传说，已驾崩无数纪元的皇帝现已重生，她毅然决定返回故乡，保护自己的族人免遭恕瑞玛的沙暴吞没。有些人把她的温柔善意当做是懦弱的表现，最终也为自己的愚鲁付出了代价。塔莉垭青春稚嫩的举止背后，是一颗敢于移山填海的雄心，和一个堪能倾世的灵魂。'
  },
  {
    id: 'braum',
    title: '弗雷尔卓德之心',
    ...
    story:
      "''想听个睡前故事吗？''“奶奶，我已经过了听故事的年龄了！”“听故事可没有年龄的限制。”小女孩嫌恶地爬到床上等着，因为她知道这场仗她赢不了。刺骨的寒风在屋外嗥叫着，将纷飞的雪花抽打成魔鬼般的旋涡。"
  },
  {
    id: 'bard',
    title: '星界游神',
    ...
    story:
      "''叮~~~''巴德游历于各个超乎凡间生命体想象的秘界之间。瓦洛兰最出色的一些学者已经付出他们的一生去尝试理解巴德所体现的奥秘。这个充满谜团的灵体在瓦洛兰的历史中有过很多名字，但星界游荡者和伟大看护者这样的头衔对他的真正意图来说只是管中窥豹而已。当不可知的宇宙构造受到威胁时，巴德就会引导所有存在的事物避过彻底灭绝的命运。"
  },
  {
    id: 'kalista',
    title: '复仇之矛',
    ...
    story:
      "''被冤枉时，我们寻求正义。被伤害时，我们进行回击。被出卖时，复仇之矛无情出击。''卡莉丝塔是充满复仇怨念的幽灵，是不灭的复仇之魂，是召唤自暗影岛的噩梦，专门猎杀背信弃义之人。背叛行为的受害者会以血泪盼望复仇，但卡莉丝塔只会挑选那些她认为正当的理由，回应召唤，施展自己的杀人技艺。所有被卡莉丝塔盯上的人都将不可避免地遭遇不幸，因为这位死亡猎手终结誓约的方式只有一种，那就是她灵魂标枪上的冷酷灵火。"
  },
  {
    id: 'kogmaw',
    title: '深渊巨口',
  ...
  },
  {
    ...
    story:
      "''我以荣誉之名前来杀你。即使你毫无荣誉可言，也一样得死。''菲奥娜是瓦洛兰的决斗家中最为可怕的一个，她的名声来自她唐突的举止和精明的头脑，以及与这些相称的对蓝钢刺剑的挥舞速度。她出生在德玛西亚王国里的劳伦特家族，并在一次几乎要毁掉家族的丑闻后，从她父亲那里夺过了家族的控制权。"
  },
  {
    id: 'evelynn',
    title: '痛苦之拥',
    ...
    story:
      '灵动且致命的伊芙琳是符文大陆上最为致命的——也是收费最高的——刺客之一。她能够随意融入暗影之中，并用这个能力来耐心地追踪她的猎物，等待着合适的机会进行袭击。伊芙琳显然不是一个彻彻底底的人类，她的来历仍然不是很清楚，人们普遍认为她出生于暗影岛——尽管她与那个磨难国度的联系仍然被神秘所笼罩着。'
  },
  {
    id: 'jarvan',
    title: '德玛西亚皇子',
  ...
  },
  {
    ...
    story:
      '常人都不会视死亡如儿戏。死确非儿戏，但如果你是萨科——则另当别论了。他是瓦洛兰第一位专业的嗜杀喜剧演员。他喜欢变着戏法将人折磨致死，然后放声大笑。他如何获得恶魔小丑的名号仍是个未解之迷。至于他来自何方也是众说纷纭，萨科对此也一直守口如瓶。大多数人认为萨科并非来自符文之地，而是从黑暗扭曲的世界召唤来的。另一些人则认为，他是人类阴暗欲望衍生出的恶魔化身，因此不能以常理而论。而最为可信的一种说法则是萨科是一名雇佣杀手，不需要服务时便捣腾他那些可笑的玩意。萨科也证明了自己确实是一个狡黠之人，每次政府当局想要捉拿他拷问一些骇人的非法暴行时，他都能设法逃避。虽然这样的传言可以让瓦洛兰当地居民稍稍宽心，但人们还是觉得政府竟然让这样的非法之徒逍遥法外，实在有点不可理喻。无论他的过往真相为何，萨科已经加入了英雄联盟，其中缘由惟其自知。萨科实在令人生畏，几乎所有的英雄同道与各路媒体都对他避而远之。唯有战争学院的召唤师们才知道为何让萨科加入英雄联盟，但大多数符文之地的人却怀疑这不过是一种手段而已，好让当权者能以此监督这个神秘莫测的家伙。不出所料，萨科在疯狂的地方大受欢迎，像祖安与诺克萨斯那些权欲熏心的召唤师便能与他打成一片。无论你做什么，千万不要告诉他你错过了他的连珠妙语。'
  },
  {
    id: 'malphite',
    title: '熔岩巨兽',
  ...
  },
  {
    ...
    story:
      "''菲兹能在战斗中让经验最最丰富的老水手们像喝醉了的旱鸭子一样滑稽，我真庆幸它站在我们这边。''几个世纪以前，一种名叫凯玛的水生种族在征服者之海的一座海底山脉下修建了一所城市，阿纳波斯，虽然凯玛族人树敌众多，但是有这座坚不可摧的堡垒保护着他们。由于这座城池所提供的超然安全感，凯玛族民们逐渐的变得自满起来。"
  },
  {
    id: 'Neeko',
    title: '万花通灵',
  ...
  },
  {
    ...
    story:
      "''嘚~~~''“风险越大，赏金越多。” 无论是美貌颜值还是危险指数，鲜有人能在任何一方面与厄运小姐媲美。作为比尔吉沃特最负盛名的赏金猎人，她的传奇故事建立在无数密布着弹孔的尸体和被捕获的混混们之上。只要比尔吉沃特那臭烘烘的码头和拾荒者棚屋中回响起她标志性的双枪，赏金告示板上的悬赏令就又少了一张。                        “黑暗即将到来……现在漆黑一片了……但我还能看见他……”病人4236如是说道。"
  },
  {
    id: 'draven',
    title: '荣耀行刑官',
    ...
    story:
      "''我的斧子无可挑剔''不同于他的兄长德莱厄斯，战场上的胜利对德莱文来说是绝对不够的。他热切渴望着人们的承认，喝彩，以及荣耀。他先是在诺克萨斯军队里寻求成名的机会，可他的戏剧天资却被严重埋没。"
  },
  {
    id: 'lissandra',
    title: '冰霜女巫',
    ...
    story:
      "''闭上眼睛，让寒冷将你夺去。''丽桑卓的魔法将纯净的冰霜之力扭曲为某种黑暗而可怕的东西。伴随着她的黑色冰霜之力，她不仅冻结敌人，还能将他们刺穿并粉碎。对于北部饱受恐吓的居民来说，她只是被称为“冰霜女巫”。但事实却更为凶险：丽桑卓是个本质上的堕落之人，她阴谋释放能力将世界转变成冰河世纪。丽桑卓努力在世界上清除一切有关于守望者的知识。利用魔法保持人形，她伪装成许多的先知和长者。"
  },
  {
    id: 'rengar',
    title: '傲之追猎者',
    ...
    story:
      "''今晚 猎个痛快！''在藏品猎人雷恩加尔的兽穴里，每一面墙上都陈列着来自瓦洛兰里最为致命的生物们的头颅、巨角、利爪与尖牙。尽管他的收藏非常广泛，但他仍然没有满足，并且不知疲倦地寻找着更加强大的猎物。他的每次猎杀都颇费时间，包括研究他的猎物，学习，以及为了与那个他绝对无法打败的怪兽的下次相遇做准备。雷恩加尔从来不知道他的亲生父母是谁，一个被尊为传奇猎人的人类将他抚养长大。他是一个完美的学生，专心地汲取着他养父的课程，并用他怪异的野性本能来改进它们。..."
  },
  {
    id: 'xinzhao',
    title: '德邦总管',
    ...
    story:
      "''嘚~~~''“人之死，难免也。可免者，唯败也。”每当德玛西亚国王嘉文三世在皇宫顶部那熠熠生辉的大理石阳台上发表激情澎湃的演讲时，赵信都会侍立于他的身旁。人称“德邦总管”的赵信是光盾王朝的私人管家。他那高深莫测且不苟言谈的守夜值勤，使得关于他的“隐秘生活”与出身来源的推测层出不穷。不管是被茶余饭后的闲谈疑为“祖安的双重间谍”，还是被《德玛西亚恒量》的社论推测为“负债累累的符文法师”，赵信从未泄露出任何蛛丝马迹，以满足大众的好奇心……这当然是有充分理由的。许多年前，诺克萨斯以其蔚为壮观的“绞肉大赛”而闻名于世。这是一个残忍而扭曲的角斗赛事：当一位斗士赢得比赛时，他要同时面对的对手（通常为战俘）数目会随之增加。这就意味着每个参赛者最终都必死无疑，只是会带着无上的荣耀死去。赵信，当时被称为“维斯塞罗”，所面对的是300名士兵，这个数目是之前记录的将近六倍。显然，这也意味着是他的最终赛事了。嘉文二世，在听闻了这个史无前例的功绩之后，偷偷地潜入角斗场，给赵信提供了另一个选择：为德玛西亚效力，惩罚那些最终要将他处死的人，以此换取他的自由。堂堂君主竟会舍生救他，赵信在震惊之余接受了嘉文二世的条件。在德玛西亚策划的突袭掩护之下，嘉文解放了赵信以及他的三百名对手。在他们撤退的途中，赵信替嘉文挡下了一支毒箭。这种忠心护主之举，来自于一个并未宣誓效忠的人，为赵信赢得了一个国王身边的职位，直到国王驾崩。目前赵信效命于先王之子嘉文三世，为收容他的国家而战，以此报答赋予他生命意义的先王恩典，光耀嘉文一族的门庭。"
  },
  {
    id: 'graves',
    title: '法外狂徒',
    ...
    story:
      "''来试试子弹吧''马尔科姆丶格雷福斯的足迹遍布整个大陆，他在许多领地、城邦和帝国都是通缉要犯。格雷福斯粗狂不羁、意志坚定，而且残忍无情无人能及，他一生的犯罪恶行为他积攒了（随后又不可避免地失去了）一笔小财。"
  },
  {
    id: 'jhin',
    title: '戏命师',
    ...
    story:
      '艺术需要相当程度的…残忍。”作为一名心思缜密的癫狂杀手，烬坚信谋杀是一门艺术。他曾在艾欧尼亚的监狱中服刑，但却因为执政议会里涌动着的暗流而得到释放，成为了权术斗争所利用的刺客。烬将手中的枪当成画笔，尽情地挥洒他所追求的残忍艺术，让受害者肝胆俱裂，令旁观者震悚难平。他在自己制作的阴森剧目里肆意取乐，让“恐怖”二字有了最合适不过的，使者。'
  },
  {
    id: 'chogath',
    title: '虚空恐惧',
  ...
  },
  {
    ...
    story:
      "''这个地方早晚会被烧成灰烬，焚毁它的不是风中飞烬，而是我的复仇之手。''在遥远的洛克法，有个叫基根丶诺和的海上掠夺者。和洛克法的其他人一样，基根和他的船员到处航行，掠夺那些倒霉蛋的财物。对某些人而言，他掠夺财物，是个魔头。但对另外一些人而言，他和大众一样只是个平凡的强盗。某个夜晚，他们正驶过北冰洋时，发现冰冻废土上闪动着奇光。"
  },
  {
    id: 'vi',
    title: '皮城执法官',
    ...
    story:
      "''先打脸，打的时候再问话。''对于蔚来说，所有问题都只是一道墙壁，一道可以用她的巨型海克斯科技拳套一拳打穿的墙壁而已。尽管她的成长过程总是伴随着违法乱纪，但现在，蔚将她的犯罪本领用来为皮尔特沃夫警方服务。蔚的傲慢态度、粗俗幽默和公然抗命，经常会激怒她那循规蹈矩的搭档，凯特琳。但即使是皮城女警也无法否认，在与犯罪团伙的斗争中，蔚是一个无价之宝。蔚的童年时代在皮尔特沃夫的一个不受法律约束的郊区度过。为了生存下去，她学会了抢劫和诈骗。通过偷窃并拆散海克斯科技硬件，她掌握了熟练的机械技术。..."
  },
  {
    id: 'karma',
    title: '天启者',
    ...
    story:
      "''灵性这种东西，外人无法从你身上剥离。要明智地使用它。''卡尔玛是一位有着不屈意志和无拘灵力的女性。她是显灵的艾欧尼亚之魂，战场上的精神支柱，保护友军击退来犯之敌。卡尔玛是一个强大的领袖，在传统和革新之间艰难地探寻着保卫艾欧尼亚和平局面的方式——迫不得已时，也会动用武力。卡尔玛看见了第三条道路，这条道路将艾欧尼亚在战争中发现的实力与这个国家仍然看重的和平传统结合在一起。现在，她正为了能让她支离破碎的祖国重新回到持久的和平状态而不停探求着。"
  },
  {
    id: 'blitzcrank',
    title: '蒸汽机器人',
    ...
    story:
      '布里茨是科技学院的奇迹，他是个慢速的金属拳手，很难被打倒。当布里茨处于致命危险时，他会自动使用法力电池制造一层保护网。'
  },
  {
    id: 'vayne',
    title: '暗夜猎手',
    ...
    story:
      "''我闻到了黑魔法的味道。''这个世界并没有人们想象中那么文明，还是有一些人愿意追随横行符文之地的暗黑魔法，并因此堕落腐败,肖娜薇恩对此了如指掌。作为德玛西亚精英家族的掌上明珠，薇恩的父亲一直让她相信她处于警卫队的保卫下。"
  },
  {
    id: 'mordekaiser',
    title: '铁铠冥魂',
    ...
    story:
      '“万物皆有一死……唯我可得永生。”名叫莫德凯撒的恶毒怨灵是萦绕于暗影岛上的一个最为可怖和可憎的灵体。被埋葬在古代铠甲中的冥魂之主据说是第一个不死灵体，甚至还是一个在暗影岛被改造前就存在的怨魂。他扭曲的灵魂，因他的苦痛和他对其他人施加的痛苦而增长着。那些胆敢在战争中直面莫德凯撒的人，将遭到可怕的诅咒：他会奴役被害者的灵魂，并让他们成为毁灭的工具。'
  },
  {
    id: 'ziggs',
    title: '爆破鬼才',
    ...
    story:
      "''吉格斯？不可理喻，危险无比，对，没错。但确实才华横溢！''吉格斯生来就有着捣鼓机械的天赋，但他自由散漫、过度亢奋的天性在约德尔科学家当中实属罕见。怀着成为黑默丁格那样的伟大发明家的雄心壮志，他很快凭借着狂躁的激情描绘出了一个个野心勃勃的工程蓝图，并且靠着他的那些充满争议的失败和前无古人的发现来为自己加油鼓劲。"
  },
  {
    id: 'garen',
    title: '德玛西亚之力',
  ...
  },
  {
    ...
    story:
      '“藐视自然规律，必将自食其果。”——茂凯暗影岛上的那些受折磨的阴影们犹如飞蛾扑火一般涌向茂凯体内的生命精华。茂凯奋力守护着生命之种，不让它落入无情的亡灵手中，但茂凯知道，他无法永远地挡住他们。他得逃离这个曾经是家园的亡者之地，因此他把自己投入大海之中，并坚信大自然会把他带到一个生机盎然的地方。他希望能在那个地方找到驱逐亡灵势力的方法，并让生命重回暗影岛。'
  },
  {
    id: 'corki',
    title: '英勇投弹手',
    ...
    story:
      '库奇是"尖啸之蛇"里最具盛名的，不单因为他无与伦比的勇气，还有他面对威胁时冷静的头脑。在加入联盟之前，库奇也效力过其他组织，他经常主动接受任务，深入敌后，在危险地带收集情报或传递信息，他在危险中成长。早晨来一场激烈的空战便是他的最高享受。'
  },
  {
    id: 'leesin',
    title: '盲僧',
    ...
    story:
      '李青用自焚的方式抗议诺克萨斯对艾欧尼亚的侵占。当人们往李青身上泼水，想扑灭火时，他的眼睛却被烧伤了。还好他没有被烧死，尽管忍受了几个星期的烧伤痛苦。但他的行动为联盟的比赛铺平了道路。'
  },
  {
    id: 'katarina',
    title: '不祥之刃',
  ...
  },
  {
    ...
    story:
      '披甲龙龟-拉莫斯瘟疫之地上蔓延的危险魔法影响了该地区的所有生灵，拉莫斯就是一个例子。'
  },
  {
    id: 'twisted',
    title: '卡牌大师',
    ...
    story:
      '崔斯特是一名声名狼藉的纸牌老千和诈骗惯犯，世界上任何有人烟的地方都有他施展魅力和赌艺的足迹，让那些富人和痴人既羡慕又嫉恨。他很少会认真起来干一件事，总是用一抹轻蔑的微笑和一副漫不经心的随性面对每一天。无论做任何事情，崔斯特永远都会在袖子里藏一张王牌。'
  },
  {
    id: 'galio',
    title: '正义巨像',
  ...
  },
  {
    ...
    story:
      '过远古的无极之道，易大师调节身体并磨练心智，直至心神合一。尽管他将暴力作为不得已的选择手段，他优雅迅速的舞剑速度却能让他快速解决问题。作为无极之道最后的门徒，易大师将生命奉献于找寻可以继承这份财富的弟子。'
  },
  {
    id: 'fiddlesticks',
    title: '末日使者',
    ...
    story:
      '那个时候，召唤师峡谷没有代表祖安的英雄。重复敲打召唤室大门得到的只有寂静。第一个进去的学徒马上就被神秘镰刀杀死。少数跟随且存活下来的人却被恐惧吓疯了，只剩下人的躯壳，语无伦次地说着群鸦和死亡。'
  },
  {
    id: 'nasus',
    title: '沙漠死神',
    ...
    story:
      '这个被称为内瑟斯的神秘生物从遥远的世界来到联盟，并且是庞大博学的沙漠帝国的一部分。'
  },
  {
    id: 'alistar',
    title: '牛头酋长',
    ...
    story:
      '作为牛头人部落里最强大的勇士，阿利斯塔一直保护着自己的部落远离瓦罗然大陆上的各种危险，直至诺克苏斯军队的到来！'
  },
  {
    id: 'kennen',
    title: '狂暴之心',
  ...
  },
  {
    ...
    story:
      '“死亡不是旅程的终点，而是起点……”卡尔萨斯是湮灭的使者，狂热地投入到死亡的美丽与清晰中。在他年轻时，他就完全沉迷于死亡的魅力中，并在追求他的黑暗欲望时变得越来越无情。渴望着与死亡合为一体的卡尔萨斯前往暗影岛，并欣然将自己献身于亡灵。卡尔萨斯转变成了死亡颂唱者，一个世间仅存的可怕巫妖，派发着受湮灭祝福的礼物。'
  },
  {
    id: 'teemo',
    title: '迅捷斥候',
  ...
  },
  {
    ...
    story:
      '她的旋律动人心魄，她的静默刹人肺腑。她从小随着神秘古琴“叆华”在艾欧尼亚孤儿院长大，之后被名叫乐斯塔拉布维尔的德玛西亚贵妇人领养并训练琴技。'
  },
  {
    id: 'soraka',
    title: '众星之子',
    ...
    story:
      '索卡拉是爱欧尼亚大陆第一个被称作星灵之子的高阶女祭司。尽管瓦罗然大陆上有很多研习魔法的祭祀，然而她是第一个真正接触到宇宙魔法的人。'
  },
  {
    id: 'kassadin',
    title: '虚空行者',
    ...
    story:
      '我要用何等华丽的语言，才能形容出卡萨丁纵横虚空的飘逸灵动。倘若你我也能如他一般打开虚空而穿梭，是不是就不会因他如鬼魅般的身影而疯狂？！卡萨丁是法系中数一数二的杀手中期游戏当之无愧的爆发之王，但是想用好他却不容易。'
  },
  {
    id: 'kindred',
    title: '永猎双子',
    ...
    story:
      '“再跟我说一次，小羔羊，哪些东西是我们要拿走的？”“所有东西，亲爱的恶狼。”各成一体但永不分离的千珏代表着死亡的双生本质。羊灵的箭矢是为那些接受命运的人们所提供的一次迅速释放。狼灵则会捕猎那些想要从自身寿命终点逃离的人们，并在他的血盆大口内为他们献上暴力的结局。尽管符文之地各个地方对千珏天性的解释不尽相同，但每个凡间生灵都必须选择自身死亡的真实面目。'
  },
  {
    id: 'ashe',
    title: '寒冰射手',
    ...
    story:
      '“艾希能够一箭射中五只鸟，这值得大肆宣传。” ——泰达米尔。弗雷尔卓德美女艾希是英雄联盟召唤师长期以来的最爱之一。作为阿瓦罗萨的直系后代，艾希是传奇三姐妹之一。她们各自宣称统治着居住在瓦洛兰大陆北部冻苔原地带的散乱部落。艾希继承了祖先精通的箭术，因此也继承了阿瓦罗萨“寒冰射手”的称号。'
  },
  {
    id: 'lux',
    title: '光辉女郎',
    ...
    story:
      '拉克丝天生就属于显赫的皇冠卫队，出自蒂玛西亚的模范家庭她注定要成就一番伟业。"她的指引之光让敌人精力憔悴，但他们更应该担心光明消逝之时"-盖伦·蒂玛西亚之力"。'
  },
  {
    id: 'cassiopeia',
    title: '魔蛇之拥',
    ...
    story:
      '当她的姐姐卡特琳娜成为最家喻户晓的英雄时，DuCouteau家族已经为诺克萨斯鞠躬尽瘁多年。DuCouteau将军最小的女儿卡西奥佩娅不像她的姐们们天性好杀，而以庄严优雅而闻名。'
  },
  {
    id: 'singed',
    title: '炼金术士',
    ...
    story:
      "''我最为致命的药剂将附上牺牲品的名字！''吉德是祖安备受尊敬的炼金世家的后裔。即使在年轻之时，他调制药剂的天赋便远在同龄人之上，很快他便在化学同道中鹤立鸡群。因此他被臭名昭著的沃里克收为徒弟也就不足为奇了。沃里克当时是诺克萨斯和艾欧尼亚对战时的军队雇佣药剂师。"
  },
  {
    id: 'rumble',
    title: '机械公敌',
    ...
    story:
      "''呃，能不能别把你的脸贴在我的装备上!''虽然出生在身材矮小的约德尔家族，但兰博矮小的身材却无比刺眼，因此在成长过程中他经常被欺负。为了生存，他必须比同龄人更好斗，更机智。这也产生了他锱铢必较的坏脾气，不管谁得罪了他，他都有仇必报。"
  },
  {
    id: 'vladimir',
    title: '猩红收割者',
  ...
  },
  {
    ...
    story:
      "''我们要以困难的方式搞定他。''艾克是一名来自祖安不良街区的奇才。他可以操纵时间，从而让任何处境都变得对自己有利。通过使用他自己的发明——Z型驱动——他可以对现实的其它分支的可能性进行探索。在不断试验多维或然率的同时，艾克还将他的时间花费在与祖安的其他走失儿童一起撒野上。尽管他酷爱这种自由自在，但只要他的朋友们遇到了威胁，他就会不顾一切地去保护他们。对于毫不知情的观测者来说，艾克总是在一次又一次且轻而易举地完成着不可能的事情。"
  },
  {
    id: 'taric',
    title: '瓦洛兰之盾',
  ...
  },
  {
    ...
    story:
      "''我造之以寒冰，形之以风雪，固之以寒冷。''瑟庄妮自小就习惯于苦难，崇尚于残暴。在其他人屈从于弗雷尔卓德的艰难险阻之时，她却视之为磨练，直到痛苦成为力量，饥饿成为鼓励，冰霜化身淘汰弱者的盟友。通过考验，她学会了要想在永冬之中成长，就必须变得冷酷无情。在瑟庄妮眼中，她的追随者们要么拥有忍耐的勇气，要么拥有赴死的权利。一旦她征服了弗雷尔卓德，她知道幸存者们便会建立一个让人畏惧国度。"
  },
  {
    id: 'urgot',
    title: '无畏战车',
  ...
  },
  {
    ...
    story:
      '"希维尔用一次又一次的胜利证实了她无愧于"战争女神"的称号"——贾克斯。希维尔在战斗中积累无数经验和技巧，她不仅能预判敌人的战术做出反应，还能增加友军的攻击和移动速度，代领他们走向胜利。'
  },
  {
    id: 'olaf',
    title: '狂战士',
  ...
  },
  {
    ...
    story:
      "''谁说恶魔一定要样貌可怖？''大多数人不会将约德尔人与令人惧怕的形象联想在一起。约德尔这个平易近人的迷你民族，虽说勇猛，但通常人们或多或少会认为他们是快乐的种族。他们那高八度的声音，以及天生的可爱外形，会激发出体型较大的民族内心深处的某种保护本能，或者至少会让他们的脑海中浮现出小孩扮大人的画面。"
  },
  {
    id: 'zyra',
    title: '荆棘之兴',
    ...
    story:
      "''婕拉渴望掌控自己的命运。''婕拉渴望掌控自己的命运。这株垂垂老矣的古老植物，为了获得第二次生命，将她的意识转移到一具人类的躯体上。"
  },
  {
    id: 'morgana',
    title: '堕落天使',
    ...
    story:
      '不是所有的姐妹都有一样的性格，莫甘娜和她的姐姐凯尔之间就有着明显的不同，甚至可以说是明显的对立。她对姐姐的恨意已经超越了一切，而对她来说她唯一的目标也就剩下姐姐了……'
  },
  {
    id: 'gangplank',
    title: '海洋之灾',
  ...
  },
  {
    ...
    story:
      '斯温在诺克苏斯最高指挥部不断升迁，经常有比他阶级更高的军官要求加入他手下。作为一名狡猾的战略家，斯温通常在战争前线蹒跚思考，并在每一场战斗后都获得授勋封赏。斯温的升迁似乎没有止境，直到进展缓慢的爱欧尼亚入侵-那场战争是官僚政治权利倾轧的混乱决策。'
  },
  {
    id: 'kled',
    title: '暴怒骑士',
    ...
    story:
      '疯狂比勇气更靠得住广受喜爱的民间英雄、无畏无赖的凶猛战士、诺克萨斯的意志化身、帝国士兵的仰慕偶像、长官眼里的定时炸弹、贵族鄙夷的送死小卒……克烈身上的光环可谓数不胜数。诸如“伟大的轻骑兵”、“高阶少将元帅中士”和“山中大将”一类的逸闻可以一直追溯到帝国初建的时日。很多军士都说，克烈参与了有史以来军团所挑起的每一场征战，“获得”了军中的每一份头衔，而且从来没有却步于任何一次战斗。虽然传闻总是不可全信，但至少有一件事毋庸置疑：只要克烈骑着胆小的斯嘎尔冲进战场，他的战斗便是为了保住所拥有的一切……或是抢走他想要的一切。'
  },
  {
    id: 'zilean',
    title: '时光守护者',
    ...
    story:
      '基兰修理着他的钟表。成百上千的钟表塞满了他的车间，一些还能工作，大部分已经坏损。他沉溺于时间之中。对他来说，这既是幸福也是诅咒。'
  },
  {
    id: 'annie',
    title: '黑暗之女',
    ...
    story:
      '安妮的父母早就知道安妮有特别之处。两岁时，安妮神奇地用魔法驯服了来自树化石林的凶猛暗影熊，把它变成她的宠物。至今，她都把 "泰迪" 带在身边。安妮通常将它变成一个玩具熊，就像普通孩子的玩偶一样。'
  },
  {
    id: 'tristana',
    title: '麦林炮手',
    ...
    story:
      '当她受到战争学院的召唤的时候，她意识到是时候实现自己的梦想了。尽管她的心还在自己的小队这边，她还是响应了战争学院的召唤，现在她在英雄联盟里作为一名英雄来保护那里的人民。。'
  },
  {
    id: 'jax',
    title: '武器大师',
    ...
    story:
      '除了贾克斯，很少有英雄的评价来自加入联盟后的行为。贾克斯是目前战争学院最多产的联赛战士。在加入联盟之前，贾克斯只是个平凡的雇佣士兵。贾克斯被放在了联盟裁决候选人名单的首位。'
  },
  {
    id: 'amumu',
    title: '殇之木乃伊',
    ...
    story:
      "''阿木木哭的时候，事情会变得糟糕，但是当他生气的时候，事情会更糟糕。''阿木木是一个矮小、好动的活尸，在世界各地游历，想要找到他的真实身份。阿木木或许是英雄联盟中最古老的英雄之一。他加入英雄联盟前的身世无人知晓，连自己也不知道。阿木木跪下来，在绷带内哭泣。无论做什么，他都无法停止哭泣、停止悲伤。最后，他站起来，决定处闯荡，寻找他的过去。"
  },
  {
    id: 'udyr',
    title: '兽灵行者',
